  ...
  methods: {
    ...
    async getOrderDetails() {
      try {
        ...
        axios
          .get(`${Const.BASE_URL}order/list/${this.orderId}`,
            {
              headers: {
                'access-token': localStorage.getItem('accessToken')
              },
    ...
    async getOrderStatuses() {
      let config = {
        method: 'get',
        url: `${Const.BASE_URL}order/status/list`,
        headers: {
          'access-token': localStorage.getItem('accessToken')
        },
      }
    ...
    updateOrderStatus(orderId, status) {
      ...
      let config = {
        method: 'post',
        url: `${Const.BASE_URL}order/update/status`,
        data: {
          status: status.code,
          orderId: orderId
        },
            ...
            <div class="col-10">
              <div class="row text-center align-items-center flex-row-reverse mb-5">
                ...
                <div class="col-3 col-lg-auto ms-lg-auto ">
                  <button v-if="order?.paymentAmount" class="btn mx-1">{{ order?.paymentMethod }}
          ...
          <div class="accordion accordion-flush" id="accordionFlushExample">
            <div class="accordion-item">
              <h2 class="accordion-header" id="flush-headingOne">
                <button class="accordion-button collapsed strong" type="button" data-bs-toggle="collapse"
                    ...
                    <div class="col-12">
                      <table class="table  table-transparent table-responsive">
                        <tr>
                          ...
                          <td class="text-end">{{ order?.shipping?.shippingMethod }}</td>
                        </tr>
                        <tr>
                          <td> Shipping Cost </td>
                          <td class="text-end">{{ this.formatter.format(order?.shipping?.shippingCost) }}</td>
                        ...
                        <tr>
                          <td>Insured </td>
                          <td class="text-end">{{ order?.shipping?.insured }}</td>
                        </tr>
                        <tr>
                          <td>Insurance Cost</td>
                          <td class="text-end">{{ this.formatter.format(order?.shipping?.insuranceCost) }}</td>
                        </tr>
                        <tr>
                          <td>Tracking Number</td>
                          <td class="text-end">{{ order?.shipping?.trackingNumber }}</td>
                        </tr>
                        <tr>
                          <td>Tracking URL</td>
                          <td class="text-end">{{ order?.shipping?.trackingUrl }}</td>
                        </tr>
                        <tr>
                          <td>Date BOL Created</td>
                          <td class="text-end">{{ order?.shipping?.dateBOLCreated }}</td>
                        </tr>
                        <tr>
                          <td>Packed Weight</td>
                          <td class="text-end">{{ order?.shipping?.packedWeight }}</td>
                        </tr>
                        <tr>
                          <td>Packed Dimensions</td>
                          <td class="text-end">{{ order?.shipping?.packedDimensions }}</td>
                        </tr>
                        <tr>
                          <td>Shipment Date</td>
                          <td class="text-end">{{ order?.shipping?.shipmentDate }}</td>
                        </tr>
                        <tr>
                          <td>Marketplace Est Delivery Date</td>
                          <td class="text-end">{{ order?.shipping?.marketPlaceEstDeliveryDate }}</td>
                        </tr>
                        <tr>
                          <td>Date Delivered</td>
                          <td class="text-end">{{ order?.shipping?.dateDelivered }}</td>
                        </tr>
                        <tr>
                          <td>Shipping Company</td>
                          <td class="text-end">{{ order?.shipping?.company?.name }}</td>
                        </tr>
                        <tr>
                          <td>Shipping Company Email</td>
                          <td class="text-end">{{ order?.shipping?.company?.email }}</td>
                        </tr>
                        <tr>
                          <td>Shipping Company Address</td>
                          <td class="text-end">{{ order?.shipping?.company?.address }}</td>
                        </tr>
                        <tr>
                          <td>Shipping Company City</td>
                          <td class="text-end">{{ order?.shipping?.company?.city }}</td>
                        </tr>
                      </table>
                    </div>
                  </div>
                    ...
                    <div class="col-12">
                      <table class="table">
                        <tr>
                          ...
                          <td class="text-end">{{ order?.purchaseOrderNumber }}</td>
                        </tr>
                        <tr>
                          <td>Invoice Number</td>
                          <td class="text-end">{{ order?.invoiceNumber }}</td>
                        </tr>
                        <tr>
                          <td>Vendor Order Number</td>
                          <td class="text-end">{{ order?.vendorOrderNumber }}</td>
                        </tr>
                        <tr>
                          <td>Notes</td>
          ...
          <div class="row">
            <div class="col-md-12 mb-3">
              ...
              <select id="paymentMethod" v-model="emailForm.vendorId" class="form-control">
                <option v-for="option in vendors" :value="option.vendorID" :key="option">{{ option.name }}
                </option>
              </select>
            </div>
            <div class="col-md-12 mb-3">
